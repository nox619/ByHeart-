...
* `database.db`: SQLite database for session and user data [{47657F95-3E75-42E6-9EE4-1A150B95A6D9}.png].
* `templates/`: Directory containing HTML structure for the UI [{47657F95-3E75-42E6-9EE4-1A150B95A6D9}.png].
* `style.css`: Custom CSS for application styling [{47657F95-3E75-42E6-9EE4-1A150B95A6D9}.png].
* `requirements.txt`: List of Python dependencies for environment setup [{47657F95-3E75-42E6-9EE4-1A150B95A6D9}.png].

## ⚙️ Setup & Installation
```bash
# Clone the repository
git clone [https://github.com/nox619/ByHeart-.git](https://github.com/nox619/ByHeart-.git)
